...
function createResearch(config: WebAccessConfig): Tool {
  return defineTool(
    'research',
    'Search the web, read three independent pages and return a one-line answer plus quoted passages. Use for current events, people, organisations, or any fact you would otherwise guess at.',
    {
      type: 'object',
