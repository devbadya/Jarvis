...
export const en = {
  ...
  'stage.title': 'Jarvis',
  'stage.prompt': 'Speak, then pause.',
  'stage.appearance': 'Appearance',
  'stage.color': 'Color',
  'stage.design': 'Design',
  'stage.voice': 'Voice',
  'stage.voice.auto': 'Automatic',
  'stage.preview': 'Hear this voice',
  'stage.hangUp': 'Hang up',
  'stage.sample': 'Hello. I am Jarvis.',
  'stage.design.orb': 'Orb',
  'stage.design.rings': 'Rings',
  'stage.design.bars': 'Bars',
  'stage.color.cyan': 'Cyan',
  'stage.color.violet': 'Violet',
  'stage.color.amber': 'Amber',
  'stage.color.emerald': 'Emerald',
  'stage.color.rose': 'Rose',
  'composer.offline':
